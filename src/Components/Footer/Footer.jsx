...
function Footer() {
  return (
    <div className="flex py-10 w-full  bg-slate-200 flex-col  pt-12">
      <div className="flex   gap-5 justify-between  self-center mt-20 w-full max-w-[1200px] max-md:flex-wrap  max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex  md:w-[20%] gap-5 justify-between my-auto text-2xl font-medium leading-6 text-black whitespace-nowrap">
          <img
            loading="lazy"
      ...
      <div className=" flex gap-5 justify-between mx-auto self-center  mt-7 w-full max-w-[1200px] max-md:flex-wrap max-md:max-w-full">
        ...
        <div className="flex gap-5 md:w-[20%] justify-between text-xl font-semibold text-black">
          <img
            loading="lazy"

...
function CardCours({ img, title, cat, dec, price }) {
  return (
    <div className="flex flex-col max-w-sm mx-auto bg-white w-[90%] h-[90%] rounded-xl overflow-hidden border border-solid shadow-lg border-[color:var(--Neutral-Light-Grey-50,#E9F0F8)]">
      ...
      <div className="flex flex-col justify-between px-4 py-2.5 w-full bg-white rounded-none">
        ...
        <div className="justify-center self-center px-6 py-3 mt-6 text-base font-medium leading-6 text-center text-white whitespace-nowrap bg-green rounded-lg">
          View Course
        </div>
      </div>
    </div>

    ...
    return (
        <div className="   bg-slate-200   py-10 min-h-screen h-fit ">
            <div className="max-w-[1100px]   py-10 mx-auto h-12 flex justify-between px-10 items-center">
                ...
                <Link to={"/Services"} className=" w-fit max-md:hidden border border-green px-5 py-2 rounded-md  text-center text-green-800 text-base font-medium  leading-normal">
                    Veiw All Services{" "}
                </Link>
            </div>
            <div
            ...
            <Link to={"/Services"} className="block w-fit  text-center mx-auto   md:hidden border border-green px-5 py-2 rounded-md  text-green-800 text-base font-medium  leading-normal">
                Veiw All Services{" "}
            </Link>
        </div>
    );

    ...
    >
      ...
      <div className="pt-10  ">
        <Link
          ...
          to="/Profile"
          className="flex justify-center items-center py-3 bg-slate-200 rounded-md mx-5 px-5  cursor-pointer mt-2 "
        >
        ...
        <Link
          ...
          className="flex justify-center items-center py-3 hover:bg-slate-200 rounded-md mx-5 mt-2  cursor-pointer "
        >
          <img className="size-6" src={edit} alt="" />
        ...
        <Link
          onClick={() => setIsOpen(!isOpen)}
          to="/Profile/Courses"
          className="flex justify-center items-center py-3 cursor-pointer hover:bg-slate-200 rounded-md mx-5 mt-2"
        >
          <img className="size-6" src={edit} alt="" />
